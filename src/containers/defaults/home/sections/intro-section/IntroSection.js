      ...
      <div className={cx('body')}>
        ...
        <div className={cx('content')}>
          ...
          <p className={cx('demo')}>
            ...
            tốt mục tiêu và nhiệm vụ đào tạo của Nhà trường... Ký túc xá Cỏ May
            nằm trong khuôn viên Trường đại học Nông Lâm, Phường Linh Trung, TP
            Thủ Đức, TP. Hồ Chí Minh, được đầu tư xây dựng từ nguồn vốn Trái
            phiếu Chính phủ; Với cơ chế hoạt động "Tự chủ tài chính, lấy thu bù
            chi" và phương châm "Nề
          </p>
