        ...
        <div className={cx('body')}>
          ...
          <div className={cx('pagination-container')}>
            <Pagination className={cx('pagination-list')}>
              <PaginationItem active className={cx('pagination-item')}>
                <Button className={cx('pagination-link')}>1</Button>
              </PaginationItem>
              <PaginationItem>
                <Button className={cx('pagination-link')}>2</Button>
              </PaginationItem>
              <PaginationItem>
                <Button className={cx('pagination-link')}>3</Button>
              </PaginationItem>
              <PaginationItem>
                <Button className={cx('pagination-link')}>4</Button>
              </PaginationItem>
              <PaginationItem>
                <Button className={cx('pagination-link')}>5</Button>
              </PaginationItem>
              <PaginationItem>
                <Button className={cx('pagination-link')}>{'Next >'}</Button>
              </PaginationItem>
              <PaginationItem>
                <Button className={cx('pagination-link')}>{'Last >>'}</Button>
              </PaginationItem>
            </Pagination>
          </div>
        </div>
