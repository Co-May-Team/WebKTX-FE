...
const imagesApi = {
  getFolders: (params) => {
    ...
    const requestUrl = `https://www.googleapis.com/drive/v3/files?q='${folderParentId}'%20in%20parents&fields=files(id,name,mimeType,createdTime)&key=${apiKey}&${queryString.stringify(params)}`
