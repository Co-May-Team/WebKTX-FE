  ...
  return (
    <div className="relative" ref={avatarDropdownRef}>
      <button
        ...
        type="button"
        aria-expanded={visibleAvatarDropdown ? "true" : "false"}
      ...
      <div
        className="absolute z-10 w-screen max-w-[260px] px-4 -right-10 sm:right-0 sm:px-0 opacity-100 translate-y-0 transition"
        id="headlessui-popover-panel-:rvv:"
        tabIndex={-1}
      >
