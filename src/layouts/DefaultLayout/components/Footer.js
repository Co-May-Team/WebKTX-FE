...
function Footer() {
  ...
  return (
    <div className='relative py-10 lg:py-16 border-t border-neutral-200 dark:border-neutral-700 bg-neutral-100 dark:bg-black dark:bg-opacity-20 shadow-inner'>
